...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', default="reader", help='plugin name');
    parser.add_argument('--target-dir', type=pathlib.Path, default=pathlib.Path('./'), help='plugin output directory');
    parser.add_argument('--config', type=pathlib.Path, default=pathlib.Path('./sample_data.json'), help='JSON configuration file');
    ...
    print("{} has generated at {}".format(args.name, target_dir))
